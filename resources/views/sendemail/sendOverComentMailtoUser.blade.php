                    	...
                    	<table border="0" cellpadding="0" cellspacing="0" width="800" id="templateContainer">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="800" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="https://acuarionautilos.com.pe/assets/images/LOGO ACUARIO3.png" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Notificación: Revista El Sendero</h1>
                                                    ...
                                                    <tr>
                                                    	<td valign="top" style="padding-top:0; padding-bottom:0;">
                                                          <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                              ...
                                                              <tr>
                                                              	<strong>Su Comentario: </strong>{!! $data['body'] !!}
                                                              </tr>
                                                          </table>
                                                        </td>
                                                    </tr>
                                    ...
                                    <p>Para una mejor visualización de su comentario puede seguir el siguiente enlace: </p>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; 2020 Nautilus Acuario, Todos los Datos Reservados.</em>
																<br />
                                                            </div>
                                                        </td>
                                                    </tr>
